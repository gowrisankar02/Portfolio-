...
<body>
    <header>
        <div class="header-content">
            ...
            <img src="/storage/emulated/0/Android/media/com.whatsapp/WhatsApp/Media/WhatsApp Documents/IMG_2627.JPG" alt="Your Profile Picture" class="profile-picture">
            <h1>gowri sankar m</h1>
    ...
    <section id="resume">
        ...
        <div class="section-content">
            <center>
            <h2>Resume</h2>
            <a href="/storage/emulated/0/Pictures/Canva/Modern Minimalist CV Resume_20250403_144517_0000.png" target="_blank" class="download-button">Download CV</a>
        </center>
        </div>
